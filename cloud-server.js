...
app.listen(PORT, () => {
    ...
    console.log(`📱 Customer Store: ${process.env.NODE_ENV === 'production' ? 'https://' + process.env.HEROKU_APP_NAME + '.herokuapp.com' : 'http://localhost:' + PORT}/customer`);
    console.log(`👨‍💼 Admin Panel: ${process.env.NODE_ENV === 'production' ? 'https://' + process.env.HEROKU_APP_NAME + '.herokuapp.com' : 'http://localhost:' + PORT}/admin`);
});